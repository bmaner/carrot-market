    ...
    <div className="px-4 py-10">
      <div className="mb-8">
        ...
        <div className="flex items-center space-x-3 py-3 border-t border-b cursor-pointer">
          ...
          <div>
            ...
            <p className="text-xs fonnt-medium text-gray-500">
              View profile &rarr;
            </p>
          </div>
        </div>
        <div className="mt-5">
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 bg-orange-500 hover:bg-orange-600 text-white py-3 font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 ">
              Talk to seller
            </button>
      ...
      <div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          {[1, 2, 3, 4, 5, 6].map((_, i) => (
            <div key={i}>
              <div className="mb-5 h-56 w-full bg-slate-300" />
