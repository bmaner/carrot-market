...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-16">
      ...
      <div className="my-5 ">
        ...
        <div className="rounded-md relative flex items-center shadow">
          ...
          <input
            ...
            type="text"
            placeholder="0.00"
            className="pl-7 rounded-md shadow-md focus:outline-none focus:ring-orange-500 focus:border-orange-500 placeholder-gray-400 appearance-none w-full px-3 py-2 border border-gray-300"
          />
      ...
      <button className="mt-5 w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none">
        Upload product
      </button>
    </div>
  );
