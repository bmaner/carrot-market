...
const Home: NextPage = () => {
  ...
  return (
    <div className="bg-slate-400 py-20 px-10 grid gap-10 xl:grid-cols-3 lg:grid-cols-2 min-h-screen xl:place-content-center">
      ...
      <div className="flex justify-between">
        ...
        <button className="mt-5 bg-blue-500 dark:bg-black dark:hover:bg-white dark:hover:text-black dark:border-white dark:border dark:text-white text-white p-3 text-center rounded-xl w-2/4 mx-auto block hover:bg-teal-500 active:bg-yellow-500 focus:bg-red-500">
          Checkout
        </button>
      </div>
      ...
      <div className="bg-white p-6 rounded-3xl shadow-xl lg:col-span-2 xl:col-span-1  ">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="py-2 px-8  bg-blue-500 text-xs text-center text-white rounded-lg ">
              Add to cart
            </button>
          </div>
        </div>
      ...
      <div className="bg-white p-10 rounded-2xl shadow-xl">
        <form className="flex flex-col space-y-2 bg-blue-100 p-5 focus-within:bg-blue-500">
          ...
          />
          <span className="peer-valid:hidden peer-invalid:block peer-invalid:text-red-500">
            This input is invalid
          </span>
          <span className="hidden peer-valid:block peer-valid:text-blue-500 peer-invalid:hidden">
            Awesome username
          </span>
